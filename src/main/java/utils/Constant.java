...
public class Constant {
    ...
    public static Map<String, String> PROVINCE_CODE_LIST = Initialization.provinceCodeListInitialize();
    //     Key: GENDER_CODE,  Value: First 2 numbers of the CENTURY
    public static Map<String, String> GENDER_CODE_LIST = Initialization.genderCodeListInitialize();
}